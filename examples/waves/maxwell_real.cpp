...
int main(int argc, char *argv[])
{
   ...
   // HypreParMatrix * A0 = new HypreParMatrix(*RAP(A, P[0]));


   // STRUMPACKRowLocMatrix *SSA = new  STRUMPACKRowLocMatrix(*A0);
   // STRUMPACKSolver *SinvAc = new STRUMPACKSolver(argc, argv, MPI_COMM_WORLD);
   // // SinvAc->SetSymmetricPattern(false);
   // // SinvAc->SetColumnPermutation(superlu::PARMETIS);
   // SinvAc->SetOperator(*SSA);
